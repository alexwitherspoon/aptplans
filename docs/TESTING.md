...
- Airport funding is grouped federal / state / local / other; state pages show federal grant allocations by fiscal year and airport (maintenance vs growth from rule-based `grant_spend_category` today; rubric LLM planned — see [GATED_EVALUATION.md](GATED_EVALUATION.md))
