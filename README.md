...
**[aptplans.org](https://aptplans.org)** is a public library of US airport master plans (every NPIAS airport, every published version we can find) and 50-state aviation, land-use, and airport law. Official sources stay the citation of record. This project also keeps a preservation copy so files survive when sponsor sites go away, and so we can show what changed.
